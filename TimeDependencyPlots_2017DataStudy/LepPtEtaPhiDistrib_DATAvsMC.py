...
if(period == "data2016"):
    ...
    inputDATAtree    = TFile.Open("/data3/Higgs/180218/AllData/ZZ4lAnalysis.root")        #2017 data (rereco json 2/2/2018)   
    inputMCDYtree    = TFile.Open("/data3/Higgs/180218/DYJetsToLL_M50/ZZ4lAnalysis.root") #DYJets 2017 MC (rereco json 2/2/2018)
    lumi     = 41.37   # fb-1
    lumiText = '41.37 fb^{-1}'
    if(ZZTree):
        treeDATA    = inputDATAtree.Get("ZZTree/candTree")
...
for i in range(len(inDATA_list)) : 
    ...
    # legend
    legend = TLegend(0.84,0.77,0.95,0.89)
