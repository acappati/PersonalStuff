...
class Candidate:
	...
	isMC = False
        ...
        #### additional variab
        self.LepLepId0 = treeEntry.LepLepId[0]
        self.LepLepId1 = treeEntry.LepLepId[1]
        self.LepLepId2 = treeEntry.LepLepId[2]
        self.LepLepId3 = treeEntry.LepLepId[3]
        self.LepPt0 = treeEntry.LepPt[0]
        self.LepPt1 = treeEntry.LepPt[1]
        self.LepPt2 = treeEntry.LepPt[2]
        self.LepPt3 = treeEntry.LepPt[3]
        self.LepEta0 = treeEntry.LepEta[0]
        self.LepEta1 = treeEntry.LepEta[1]
        self.LepEta2 = treeEntry.LepEta[2]
        self.LepEta3 = treeEntry.LepEta[3]
        self.LepPhi0 = treeEntry.LepPhi[0]
        self.LepPhi1 = treeEntry.LepPhi[1]
        self.LepPhi2 = treeEntry.LepPhi[2]
        self.LepPhi3 = treeEntry.LepPhi[3]
        ####
...
#            line  += ":" + "{0:.3f}".format(self.kds.KD_qqgrav)
            ...
            #### additional variab
            line += ":" + "{0:d}".format(self.LepLepId0)
            line += ":" + "{0:d}".format(self.LepLepId1)
            line += ":" + "{0:d}".format(self.LepLepId2)
            line += ":" + "{0:d}".format(self.LepLepId3)
            line += ":" + "{0:.3f}".format(self.LepPt0)
            line += ":" + "{0:.3f}".format(self.LepPt1)
            line += ":" + "{0:.3f}".format(self.LepPt2)
            line += ":" + "{0:.3f}".format(self.LepPt3)
            line += ":" + "{0:.3f}".format(self.LepEta0)
            line += ":" + "{0:.3f}".format(self.LepEta1)
            line += ":" + "{0:.3f}".format(self.LepEta2)
            line += ":" + "{0:.3f}".format(self.LepEta3)
            line += ":" + "{0:.3f}".format(self.LepPhi0)
            line += ":" + "{0:.3f}".format(self.LepPhi1)
            line += ":" + "{0:.3f}".format(self.LepPhi2)
            line += ":" + "{0:.3f}".format(self.LepPhi3)
            ####
